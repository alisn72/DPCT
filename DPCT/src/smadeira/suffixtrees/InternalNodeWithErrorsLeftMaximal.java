 ...
 * @version 1.0
 */
public class InternalNodeWithErrorsLeftMaximal
    extends InternalNode {

  public InternalNodeWithErrorsLeftMaximal() {
    super();
  }
   ...
   */
  public InternalNodeWithErrorsLeftMaximal(int leftIndex, int length,
