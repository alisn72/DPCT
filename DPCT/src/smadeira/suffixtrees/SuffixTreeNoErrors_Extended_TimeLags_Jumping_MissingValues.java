 ...
 * @version 1.0
 */
public class SuffixTreeNoErrors_Extended_TimeLags_Jumping_MissingValues
    extends SuffixTreeNoErrors_Extended_TimeLags implements Serializable {
   ...
   */
  public SuffixTreeNoErrors_Extended_TimeLags_Jumping_MissingValues(int
  ...
  public int computeRowNumber(LeafNodeNoErrors node) {
    ...
    int rowNumber = 2 * this.numberOfGenes + 4 * this.maxTimeLag * this.numberOfGenes + terminator + 1;
    return (rowNumber);
  }
