 ...
 *                 biclusters with exact time lagged patterns.</p>
 *
 ...
 * @version 1.0
 */
public class InternalNodeNoErrors_Extended_TimeLags
    extends InternalNodeNoErrors_Extended implements Serializable {
   ...
   */
  public InternalNodeNoErrors_Extended_TimeLags() {
    super();
   ...
   */
  public InternalNodeNoErrors_Extended_TimeLags(int leftIndex, int length,
  ...
  public String printInfo() {
    return ("numberOfLeaves = " + this.numberOfLeaves + " " + "pathLength = " +
            ...
            "isMaximal_After_TimeLags = " + this.isMaximal_After_TimeLags);
  }
