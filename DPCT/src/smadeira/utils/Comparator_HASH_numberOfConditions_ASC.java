 ...
 *           number of conditions in ascending order.</p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_numberOfConditions_ASC
   ...
   *        metric table from
   */
  public Comparator_HASH_numberOfConditions_ASC(Biclustering biclustering) {
    super(biclustering);
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(Integer.valueOf(bicluster.getID()),
                  bicluster.getNumberOfConditions());
   ...
   * number of conditions of the first bicluster is less than, equal
