 ...
 * @version 1.0
 */
public class Comparator_HASH_numberOfConditions_DESC
    extends Comparator_HASH_numberOfConditions_ASC {
  /**
   * Creates a new <code>Comparator</code> which stores an hash table with
   * the number of conditions for each bicluster in
   * <code>biclustering</code>.
   *
   * @param biclustering the group of biclusters to initialize the
   *        metric table from
   */
  public Comparator_HASH_numberOfConditions_DESC(Biclustering biclustering) {
    super(biclustering);
  }
   ...
   * number of conditions of the first bicluster is greater than, equal to, or less
   * than the number of conditions of the second.
   *
