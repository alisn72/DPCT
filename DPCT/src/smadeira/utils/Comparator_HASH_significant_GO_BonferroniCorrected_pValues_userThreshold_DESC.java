 ...
 *           number of significant GO Bonferroni corrected p-values for
 *           a given p-value user threshold in descending order.</p>
 *
 ...
 *                 Bonferroni corrected p-values for
...
public class
   ...
   * a given p-value user threshold for each bicluster in
  ...
  public
    ...
    for (Bicluster bicluster : biclusters) {
      ...
      metrics.put(bicluster.getID(),
                  bicluster.
          computeSignificant_GO_BonferroniCorrected_pValues_UserThreshold(
          result, GO_pValues_userThreshold));
