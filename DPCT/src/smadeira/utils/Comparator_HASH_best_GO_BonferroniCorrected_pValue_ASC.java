 ...
 *           best GO Bonferroni corrected p-value in ascending order.</p>
 *
 * <p>Description: This <code>Comparator</code> stores an hash table with
 *                 the best GO Bonferroni corrected p-value for each bicluster
 ...
 *                 allows to sort biclusters by their best GO Bonferroni
 *                 corrected p-value in ascending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_best_GO_BonferroniCorrected_pValue_ASC
    extends AbstractComparator_HASH<Double> {
  /**
   * Creates a new <code>Comparator</code> which stores an hash table with
   * the best GO Bonferroni corrected p-value for each bicluster in
   ...
   * @param go GOFrontEnd
   */
  public Comparator_HASH_best_GO_BonferroniCorrected_pValue_ASC(Biclustering
      biclustering, GOFrontEnd go) {
    super(biclustering);
    ...
    for (Bicluster bicluster : biclusters) {
      ...
      metrics.put(bicluster.getID(),
                  bicluster.computeBest_GO_BonferroniCorrected_pValue(result));
   ...
   * best GO Bonferroni corrected p-value of the first bicluster is
   * less than, equal to, or greater than the best GO Bonferroni corrected
