 ...
 *           number of highly significant GO Bonferroni corrected p-values
 *           in descending order.</p>
 *
 * <p>Description: This <code>Comparator</code> stores an hash table with
 *                 the number of highly significant GO Bonferroni corrected
...
public class
   ...
   * the number of highly significant GO Bonferroni corrected p-values for
   ...
   * @param go GOFrontEnd
   */
  public Comparator_HASH_highlySignificant_GO_BonferroniCorrected_pValues_DESC(
   ...
   * number of highly significant GO Bonferroni corrected p-values of
   * the first bicluster is greater than, equal to, or less than the
   * number of highly significant GO Bonferroni corrected
