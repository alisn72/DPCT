...
public class Comparator_HASH_ARV_ASC
  ...
  public Comparator_HASH_ARV_ASC(Biclustering biclustering) {
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(Integer.valueOf(bicluster.getID()), bicluster.computeARV());
   ...
   * ARV of the first bicluster is less than, equal to, or greater
   * than the ARV of the second.
   *
