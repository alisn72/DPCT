 ...
 *                 between two biclusters by their variances. When passed as an
 *                 argument to <code>Arrays</code> or <code>Collections</code>
 *                 <code>sort</code> methods, this <code>Comparator</code>
 *                 allows to sort biclusters by their variances in ascending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_VAR_ASC
   ...
   *        metric table from
   */
  public Comparator_HASH_VAR_ASC(Biclustering biclustering) {
    super(biclustering);
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(bicluster.getID(), bicluster.computeVAR());
   ...
   * variance of the first bicluster is less than, equal to, or greater
