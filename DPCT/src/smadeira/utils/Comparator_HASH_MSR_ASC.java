...
public class Comparator_HASH_MSR_ASC
  ...
  public Comparator_HASH_MSR_ASC(Biclustering biclustering) {
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(bicluster.getID(), bicluster.computeMSR());
   ...
   * MSR of the first bicluster is less than, equal to, or greater
   * than the MSR of the second.
   *
