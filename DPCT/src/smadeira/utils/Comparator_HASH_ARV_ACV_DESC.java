 ...
 *           differences between their ARV and ACV in descending order.</p>
 *
 ...
 *                 allows to sort biclusters by their ARV-ACV in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_ARV_ACV_DESC
    extends Comparator_HASH_ARV_ACV_ASC {
  /**
   ...
   *        metric table from
   */
  public Comparator_HASH_ARV_ACV_DESC(Biclustering biclustering) {
    super(biclustering);
  }
