 ...
 *           differences between their ARV and MSR in ascending order.</p>
 *
 ...
 *                 allows to sort biclusters by their ARV-MSR in ascending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_ARV_MSR_ASC
   ...
   *        metric table from
   */
  public Comparator_HASH_ARV_MSR_ASC(Biclustering biclustering) {
    super(biclustering);
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(Integer.valueOf(bicluster.getID()),
                  bicluster.computeARV() - bicluster.computeMSR());
   ...
   * ARV-MSR of the first bicluster is less than, equal to, or greater
