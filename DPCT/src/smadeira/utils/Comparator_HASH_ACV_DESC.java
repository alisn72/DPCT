 ...
 *                 allows to sort biclusters by their ACV in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_ACV_DESC
    extends Comparator_HASH_ACV_ASC {
  /**
   ...
   *        metric table from
   */
  public Comparator_HASH_ACV_DESC(Biclustering biclustering) {
    super(biclustering);
  }
   ...
   * ACV of the first bicluster is greater than, equal to, or less
