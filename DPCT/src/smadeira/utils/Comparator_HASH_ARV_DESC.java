 ...
 *                 allows to sort biclusters by their ARV in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_ARV_DESC
    extends Comparator_HASH_ARV_ASC {
  /**
   ...
   *        metric table from
   */
  public Comparator_HASH_ARV_DESC(Biclustering biclustering) {
    super(biclustering);
  }
   ...
   * ARV of the first bicluster is greater than, equal to, or less
