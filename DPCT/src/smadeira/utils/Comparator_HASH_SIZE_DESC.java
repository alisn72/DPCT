 ...
 *                 between two biclusters by their sizes. When passed as an
 *                 argument to <code>Arrays</code> or <code>Collections</code>
 *                 <code>sort</code> methods, this <code>Comparator</code>
 *                 allows to sort biclusters by their sizes in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_SIZE_DESC
    extends Comparator_HASH_SIZE_ASC {
  /**
   ...
   *        metric table from
   */
  public Comparator_HASH_SIZE_DESC(Biclustering biclustering) {
    super(biclustering);
  }
   ...
   * size of the first bicluster is greater than, equal to, or less
