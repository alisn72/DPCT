 ...
 *                 allows to sort biclusters by their MSR in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_MSR_DESC
    extends Comparator_HASH_MSR_ASC {
  /**
   ...
   *        metric table from
   */
  public Comparator_HASH_MSR_DESC(Biclustering biclustering) {
    super(biclustering);
  }
   ...
   * MSR of the first bicluster is greater than, equal to, or less
