...
public class Comparator_HASH_SIZE_ASC
  ...
  public Comparator_HASH_SIZE_ASC(Biclustering biclustering) {
    ...
    for (Bicluster bicluster : biclusters) {
      metrics.put(bicluster.getID(), bicluster.computeSIZE());
   ...
   * size of the first bicluster is less than, equal to, or greater
   * than the size of the second.
   *
