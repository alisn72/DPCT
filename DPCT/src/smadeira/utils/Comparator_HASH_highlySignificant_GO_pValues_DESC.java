 ...
 *           number of highly significant GO p-values in descending order.</p>
 *
 * <p>Description: This <code>Comparator</code> stores an hash table with
 *                 the number of highly significant GO p-values for each
 *                 bicluster in a group of biclusters.
 ...
 *                 biclusters by their number of highly significant GO
 *                 p-values in descending order.
 * </p>
 *
 ...
 * @version 1.0
 */
public class Comparator_HASH_highlySignificant_GO_pValues_DESC
    extends AbstractComparator_HASH<Integer> {
  /**
   * Creates a new <code>Comparator</code> which stores an hash table with
   * the number of highly significant GO p-values for
   ...
   * @param go GOFrontEnd
   */
  public Comparator_HASH_highlySignificant_GO_pValues_DESC(
    ...
    for (Bicluster bicluster : biclusters) {
      ...
      metrics.put(bicluster.getID(),
                  bicluster.computeHighlySignificant_GO_pValues(result));
   ...
   * number of highly significant GO p-values of
   * the first bicluster is greater than, equal to, or less than the
   * number of highly significant GO p-values of the second.
   *
