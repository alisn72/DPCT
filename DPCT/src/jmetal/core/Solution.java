...
public class Solution implements Serializable {  
  ...
  public int numberOfVariables() {
    ...
    public int numberOfGeneVariables() {
        return problem_.numberOfGeneVariables_ ;
    }
    public int numberOfConditionVariables() {
        return problem_.numberOfConditionVariables_;
    }
  /** 
