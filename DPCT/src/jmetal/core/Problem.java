...
public abstract class Problem implements Serializable {
  ...
  public int numberOfGeneVariables_;
    public int numberOfConditionVariables_;

    public int sizeOfGenePart;
    public int sizeOfConditionPart;
  public  int numberOfRow;
    public Matrix geneExpressionData;
    public String geneExpPath;
  ...
  public abstract int GetNumberOfOnes(Solution solution)throws JMException ;
  ...
  //public abstract double evaluatePopulation(SolutionSet population);
} // Problem
