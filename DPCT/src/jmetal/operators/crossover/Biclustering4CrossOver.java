 ...
 * solutions.
 */
public class Biclustering4CrossOver extends Crossover {
    /**
     ...
     */
    public Biclustering4CrossOver(HashMap<String, Object> parameters) {
        super(parameters) ;
        ...
        try {
            if (PseudoRandom.randDouble() < probability) {
                for(int x=0;x<numberOfRows;x++) {
                    ...
                    int gCrossoverPoint = PseudoRandom.randInt(column, column + sizeOfGenePart - 1);
                    int valueX1;
                    int valueX2;
                    for (int i = gCrossoverPoint; i < column + sizeOfGenePart; i++) {
                    ...
                    int cCrossoverPoint = PseudoRandom.randInt(column + sizeOfGenePart, column + sizeOfGenePart+sizeOfConditionPart - 1);
                    for (int i = cCrossoverPoint; i < column + sizeOfGenePart+sizeOfConditionPart; i++) {
//                        valueX1 = (int) parent1.getDecisionVariables()[i].getValue();
//                        valueX2 = (int) parent2.getDecisionVariables()[i].getValue();
                        valueX1 = (int)x1.getValue(i);
                        valueX2 = (int)x2.getValue(i);
