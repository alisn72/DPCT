...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("Biclustering2CrossOver"))
      return new Biclustering2CrossOver(parameters);
    else if (name.equalsIgnoreCase("Biclustering3CrossOver"))
      return new Biclustering3CrossOver(parameters);
    else if (name.equalsIgnoreCase("Biclustering4CrossOver"))
      return new Biclustering4CrossOver(parameters);
    else if( name.equalsIgnoreCase("SO_TwoPointCrossover"))
      return new SO_TwoPointCrossover(parameters);
    else if( name.equalsIgnoreCase("SO_TwoPointCrossover2"))
      return new SO_TwoPointCrossover2(parameters);
    else if(name.equalsIgnoreCase("SO_TwoPointCrossoverWithCorrection"))
      return  new SO_TwoPointCrossoverWithCorrection(parameters);
    else {
