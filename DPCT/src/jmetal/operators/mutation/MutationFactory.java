...
public class MutationFactory {
  ...
  public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException{
    ...
    else if( name.equalsIgnoreCase("Biclustering2Mutation"))
      return  new Biclustering2Mutation(parameters);
    else if( name.equalsIgnoreCase("Biclustering3Mutation"))
      return  new Biclustering3Mutation(parameters);
    else if( name.equalsIgnoreCase("Biclustering4Mutation"))
      return  new Biclustering4Mutation(parameters);
    else if( name.equalsIgnoreCase("SO_Mutation"))
      return new SO_Mutation(parameters);
    else
    {
