 ...
 */
public class Biclustering2Mutation extends Mutation{
    /**
     ...
     */
    public Biclustering2Mutation(HashMap<String, Object> parameters) {
        super(parameters) ;
    ...
    public void doMutation(double probability, Solution solution) throws JMException {
        ...
        for (int var = 0; var < solution.numberOfGeneVariables(); var++) {
            if (PseudoRandom.randDouble() < probability) {
                int rand = PseudoRandom.randInt(0, solution.getProblem().geneExpressionData.sizeOfProteins-1);
                x.setValue(var, rand) ;
            } // if
        } // for
        for (int var = solution.numberOfGeneVariables(); var < solution.numberOfVariables(); var++) {
            if (PseudoRandom.randDouble() < probability) {
                int rand = PseudoRandom.randInt(0,solution.getProblem().geneExpressionData.sizeOfConditions-1);
                x.setValue(var, rand) ;
            } // if
        } // for
    } // doMutation
